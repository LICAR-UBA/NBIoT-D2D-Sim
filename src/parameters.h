...
/*--- Noise power --*/
#define _sigma2 -79.95 /*--- dBm --*/
#define _sigma2_W 1.e-11
...
/*--- Path-loss exponent ---*/
#define _alpha { 3.40, 3.42, 3.44, 3.46, 3.48, 3.50, 3.52, 3.54, 3.56, 3.58, 3.60, 3.62, 3.64, 3.66, 3.68, 3.70 }
...
#define _no_bs 1
#define _bs_x { 300 } /*--- meters --*/
#define _bs_y { 300 } /*--- meters --*/
#define _bs_r { 200 } /*--- meters --*/
#define _bs_p { 23 } /*--- dBm --*/

/*--- DUE positions, radius and power ----*/
/*--- Just one DUE is allowed ----*/
#define _no_dues 1
#define _due_x 600  /*--- meters ----*/
#define _due_y 300  /*--- meters ----*/
